	...
	if(typeof set_switchery != 'function'){
		window.set_switchery = function(){
			if($('#prod').length){
				...
				$(".sw99").each(function(){
					new Switchery(document.getElementById('men_'+$(this).data('id')), {color:'rgb(100, 189, 99)', secondaryColor: '#cc2424', jackSecondaryColor: '#c8ff77'});
					var changeCheckbox = document.querySelector('#men_'+$(this).data('id'));
					changeCheckbox.onchange = function() {
					  //alert($(this).data('id'));
					  ajax_load(base_url+'index.php/'+user_type+'/'+module+'/menu_publish_set/'+$(this).data('id')+'/'+changeCheckbox.checked,'men_','others');
					  if(changeCheckbox.checked == true){
						$.activeitNoty({
							type: 'success',
							icon : 'fa fa-check',
				...
				$(".sw").each(function(){
					...
					changeCheckbox.onchange = function() {
					  //alert($(this).data('id'));
					  ajax_load(base_url+'index.php/'+user_type+'/'+module+'/'+set+'/'+wid+'/'+changeCheckbox.checked,'site','othersd');
					  if(changeCheckbox.checked == true){
						$.activeitNoty({
							type: 'success',
							icon : 'fa fa-check',
