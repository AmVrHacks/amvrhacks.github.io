...
class Payment_model extends CI_Model {
	...
	function paypal_package_payment($step='',$cost='',$user='',$package='',$product=''){
		...
		if($step == 'initiate'){
			...
			$this->paypal->add_field('notify_url', base_url() . 'index.php/home/paypal_responses/notify');
			$this->paypal->add_field('cancel_return', base_url() . 'index.php/home/paypal_responses/cancel');
			$this->paypal->add_field('return', base_url() . 'index.php/home/paypal_responses/success');
	...
	function paypal_package_payment_user($step='',$cost='',$user='',$package=''){
		...
		if($step == 'initiate'){
			...
			$this->paypal->add_field('custom', $payments_id);
			$this->paypal->add_field('business', $paypal_email);
			$this->paypal->add_field('notify_url', base_url() . 'index.php/home/paypal_responses_user/notify');
			$this->paypal->add_field('cancel_return', base_url() . 'index.php/home/paypal_responses_user/cancel');
			$this->paypal->add_field('return', base_url() . 'index.php/home/paypal_responses_user/success');
			...
			$this->session->set_userdata('payments_id', '');
			$this->session->set_flashdata('alert', 'payment_cancel');
			redirect(base_url() . 'index.php/home/user_package/', 'refresh');
		} elseif($step == 'success'){
			$this->session->set_userdata('payments_id', '');
			redirect(base_url() . 'index.php/home/user_package/', 'refresh');
		}
