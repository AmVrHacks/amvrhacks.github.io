        ...
        <div class="container">
            ...
            ?>
                    <div class="col-md-<?php echo $size; ?>">
                        ...
                        <?php foreach($widget_set as $row){ 
                            $id=$row;
                            //if( && $this->db->get_where('widget',array('widget_id'=>$id))->row()->status == 'ok' ){
                            if($id == 1 ){
                        ?>
                            <h4><?php echo $this->Crud_model->get_type_name_by_id('widget',$id,'title') ;?></h4>
                            <div class="widget">
                                        ...
                                        <div id="collapse<?php echo $row['category_id'];?>" class="panel-collapse collapse" style="height: 0px;">
                                            ...
                                            ?>
                                                <li class="list-group-item">
                                                    <span class="badge base"><?php echo count($this->db->get_where('product',array('sub_category_id'=>$row2['sub_category_id']))->result_array()); ?></span>
                                                    <a href="<?php echo base_url(); ?>template/front/"><?php echo $row2['name'];?></a>
                                                </li>
                                            <?php
                                            }
                                            ?>
                            ...
                            <?php } else if($id==2) { ?>
                                <div class="panel panel-default panel-sidebar-1">
                                    <div class="panel-heading" style="padding:10px 15px !important;"><h2><?php echo $this->Crud_model->get_type_name_by_id('widget',$id,'title') ;?></h2></div>
                            ...
                            ?>		
                            <div class="panel panel-default panel-sidebar-1">
                                <div class="panel-heading"><h2><?php echo $this->Crud_model->get_type_name_by_id('widget',$id,'title') ;?></h2></div>
                                <div class="panel-body">                                        
