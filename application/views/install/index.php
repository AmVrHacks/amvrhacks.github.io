...
<head>
	...
	<title>Active Classified CMS</title>
            ...
            <div id="page-content">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                                ...
                                <?php echo form_open(base_url().'index.php/install/do_install' , array('id' => 'demo-bv-wz-form' , 'class' => 'form-horizontal'));?>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div id="demo-bv-tab4" class="tab-pane  mar-btm text-center">
                                                ...
                                                <p class="text-muted rmb" style="display:block;">
                                                	Thank you for installing "Active Classified CMS". Best wishes for the next 
                                                 	<h5>It takes about 2-3 Munites</h5>
                                                 </p>
                                                
                                                <div class="ads" style="display:none;">
                                                    <a class="btn btn-info" target="_blank" href="https://prowebber.ru/" style="margin-bottom:7px;">More scripts</a>
                                    ...
                                    <div class="panel-footer text-right" style="background-color: #fff;">
                                        <div class="box-inline">
                                            ...
                                            <button type="button" class="finish btn btn-success submitter" disabled>Install Classified CMS</button>
                                            <?php } ?>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <center> 2016 &copy; All Rights Reserved @ <a href="about:blank">Active Classified CMS </a></center>

                        <center> Developed by <a href="https://activeitzone.com/index.php"><u><b>Active IT zone</b></u> , 2016 </a></center>
                    </div>
