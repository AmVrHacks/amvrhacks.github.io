            ...
            <div class="panel-body">
                <table class="table table-striped" style="border-radius:3px;">
                    ...
                    <tr>
                        ...
                        <td class="custom_td"><a href="<?php echo base_url();?>index.php/home/product_view/<?php echo $row['product']?>" target="_blank"><?php echo $this->Crud_model->get_type_name_by_id('product',$row['product'],'title');?></a></td>
                    </tr>
