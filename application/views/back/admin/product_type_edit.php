...
?>
	<div class="tab-pane fade active in" id="edit">
		<?php
			echo form_open(base_url() . 'index.php/admin/product_type/update/' . $row['product_type_id'], array(
                    ...
                    <select class="demo-chosen-select" 
                          title="Choose one of the following..." data-width="100%"           
                           name="tym_typ">
                             ...
                             <option value="day" <?php if($featured_for[1] == 'day'){ echo 'selected'; } ?>><?php echo translate('day');?></option>
                             <option value="month" <?php if($featured_for[1] == 'month'){ echo 'selected'; } ?>><?php echo translate('month');?></option>
                             <option value="year" <?php if($featured_for[1] == 'year'){ echo 'selected'; } ?>><?php echo translate('year');?></option>
                    </select>
                </div>
        	</div>
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <select class="demo-chosen-select" 
                          title="Choose one of the following..." data-width="100%"           
                           name="tym_typ1">
                             <option value=""><?php echo translate('Select One');?></option>
                             <option value="day" <?php if($shown_for[1] == 'day'){ echo 'selected'; } ?>><?php echo translate('day');?></option>
                             <option value="month" <?php if($shown_for[1] == 'month'){ echo 'selected'; } ?>><?php echo translate('month');?></option>
                             <option value="year" <?php if($shown_for[1] == 'year'){ echo 'selected'; } ?>><?php echo translate('year');?></option>
                    </select>
                </div>
           </div>
           <div class="form-group">
