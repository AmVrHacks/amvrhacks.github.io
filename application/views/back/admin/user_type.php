<div id="content-container">
	<div id="page-title">
		<h1 class="page-header text-overflow" ><?php echo translate('manage_user_package');?></h1>
	</div>
	<div class="tab-base">
		<div class="panel">
				...
				<div class="tab-content">
					<div style="border-bottom: 1px solid #ebebeb;padding: 25px 5px 5px 5px;"
						...
						<button class="btn btn-primary btn-labeled fa fa-plus-circle pull-right mar-rgt" 
                        	onclick="ajax_modal('add','<?php echo translate('add_user_package'); ?>','<?php echo translate('successfully_added!'); ?>','user_type_add','')">
								<?php echo translate('create_user_package');?>
                                	</button>
					</div>
					<br>
	...
	function set_switchery(){
		$(".aiz_switchery").each(function(){
			...
			changeCheckbox.onchange = function() {
			  ...
			  $('#sw2').load(base_url+'index.php/'+user_type+'/'+module+'/'+$(this).data('set')+'/'+$(this).data('id')+'/'+changeCheckbox.checked);
