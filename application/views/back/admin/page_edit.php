                                	...
                                	<div class="panel panel-bordered panel-info">
                                		...
                                		<div class="panel-body">
                                    		...
                                    		<div class="col-sm-12 widget" <?php if($type !== 'widget'){ ?>style="display:none;"<?php } ?>>                                            
                                				<select class="demo-cs-multiselect widget_select" name="" multiple >                                				<option value=""><?php echo translate('select_type'); ?></option>
                                                <?php
                                                    $data=$this->db->get('widget')->result_array();
                                                    foreach($data as $row2){
                                                ?>                                
                                					<option value="<?php echo $row2['widget_id']?>" <?php if(in_array($row2['widget_id'],$widget)){ ?>selected<?php } ?> ><?php echo $row2['title']; ?></option>
                                                <?php
                                                    }
                                                ?>
                                  		  	</select>
    ...
    <script>
		...
		$("#part_num").click(function(){
			...
			htmls =	htmls
				...
				+'					<option value="<?php echo $row['widget_id']?>"><?php echo $row['title']; ?></option>'
								<?php
									}
								?>
				+'  		  	</select>'
