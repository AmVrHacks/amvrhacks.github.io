                ...
                <div class="tab-content bg_grey">
                    ...
                    <div id="page-1" class="tab-pane fade active in">
                        <div class="panel">
                            ...
                            <?php
                                $page_id=1;
                                echo form_open(base_url() . 'index.php/admin/widget/do_serial/1', array(
                    ...
                    <div id="page-2" class="tab-pane fade">
                        <div class="panel">
                            ...
                            <?php
                                $page_id=2;
                                echo form_open(base_url() . 'index.php/admin/widget/do_serial/2', array(
                                    'class' => 'form-horizontal',
                                    'method' => 'post',
                                    'id' => 'page_serial2',
                                    'enctype' => 'multipart/form-data'
                    ...
                    <div id="page-3" class="tab-pane fade">
                        <div class="panel">
                            ...
                            <?php
                                $page_id=3;
                                echo form_open(base_url() . 'index.php/admin/widget/do_serial/3', array(
                                    'class' => 'form-horizontal',
                                    'method' => 'post',
                                    'id' => 'page_serial3',
                                    'enctype' => 'multipart/form-data'
                    ...
                    <div id="page-4" class="tab-pane fade">
                        <div class="panel">
                            ...
                            <?php
                                $page_id=4;
                                echo form_open(base_url() . 'index.php/admin/widget/do_serial/4', array(
                                    'class' => 'form-horizontal',
                                    'method' => 'post',
                                    'id' => 'page_serial4',
                                    'enctype' => 'multipart/form-data'
                    ...
                    <div id="page-5" class="tab-pane fade">
                        <div class="panel">
                            ...
                            <?php
                                $page_id=1;
                                echo form_open(base_url() . 'index.php/admin/widget/do_serial/5', array(
                                    'class' => 'form-horizontal',
                                    'method' => 'post',
                                    'id' => 'page_serial5',
                                    'enctype' => 'multipart/form-data'
                    ...
                    <div id="page-6" class="tab-pane fade">
                        <div class="panel">
                            ...
                            <?php
                                $page_id=12;
                                echo form_open(base_url() . 'index.php/admin/widget/do_serial/12', array(
                                    'class' => 'form-horizontal',
                                    'method' => 'post',
                                    'id' => 'page_serial6',
                                    'enctype' => 'multipart/form-data'
