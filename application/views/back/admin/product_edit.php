                    ...
                    <div class="tab-content">
                        <div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <?php echo $this->Crud_model->select_html('category','category_id','name','edit','demo-chosen-select required',$row['category_id'],'','','get_cat'); ?>
                                </div>
                            </div>
                            <div class="form-group btm_border" id="sub" >
                                ...
                                <div class="col-sm-6" id="sub_cat">
                                    <?php echo $this->Crud_model->select_html('sub_category','sub_category_id','name','edit','demo-chosen-select required',$row['sub_category'],'','','get_cat'); ?>
                                </div>
                            </div>
